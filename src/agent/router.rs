...
use super::{
    handlers::{board, moderation, notification, pm, system, topic, verify},
...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/moderation/bans", get(moderation::list))
        .route("/moderation/bans/apply", post(moderation::apply))
